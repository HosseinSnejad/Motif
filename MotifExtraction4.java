...
public class MotifExtraction4 {
	...
	public static void main(String [] args ) throws FileNotFoundException {
    	...
    	File file2 = new File("Result4.txt");
    ...
    //	TM6.add(AminoAcid.A);TM7.add(AminoAcid.Dash);TM7.add(AminoAcid.D);TM7.add(AminoAcid.Dash);TM7.add(AminoAcid.K);TM7.add(AminoAcid.T);TM7.add(AminoAcid.Dash);
    	...
    	int C = 0;
    	int falsePositive = 0;
    	ArrayList<ArrayList<AminoAcid>> PredictedMotifs = new ArrayList();;
    			...
    			for(Iterator it = Result.get(k).iterator(); it.hasNext();) {
    				...
    				if(Consensus(Final4Mers).get(0) == AminoAcid.A && Consensus(Final4Mers).get(3) == AminoAcid.T && 
    					...
    					M1+=1;
    						...
    						Consensus(Final4Mers).get(4) == AminoAcid.E && Consensus(Final4Mers).get(6) == AminoAcid.Y) {
    					M2+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.Q && Consensus(Final4Mers).get(2) == AminoAcid.W && 
    						Consensus(Final4Mers).get(5) == AminoAcid.H && Consensus(Final4Mers).get(6) == AminoAcid.N) {
    					M3+=1;
    				}
    				else if(Consensus(Final4Mers).get(3) == AminoAcid.L && Consensus(Final4Mers).get(4) == AminoAcid.S && 
    						Consensus(Final4Mers).get(5) == AminoAcid.T && Consensus(Final4Mers).get(6) == AminoAcid.M) {
    					M4+=1;
    				}
    				else if(Consensus(Final4Mers).get(1) == AminoAcid.R && Consensus(Final4Mers).get(3) == AminoAcid.C && 
    						Consensus(Final4Mers).get(4) == AminoAcid.I && Consensus(Final4Mers).get(6) == AminoAcid.V) {
    					M5+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.M && Consensus(Final4Mers).get(1) == AminoAcid.K && 
    						Consensus(Final4Mers).get(3) == AminoAcid.F && Consensus(Final4Mers).get(6) == AminoAcid.P) {
    					M6+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.A && Consensus(Final4Mers).get(2) == AminoAcid.D && 
    						Consensus(Final4Mers).get(4) == AminoAcid.K && Consensus(Final4Mers).get(5) == AminoAcid.T) {
    					M7+=1;
    				}
    				else {
    					falsePositive +=1 ;
		...
		// System.out.println("PredictedMotifs" + PredictedMotifs);
		if(M1 > 1) M1 = 1;
		if(M2 > 1) M2 = 1;
		if(M3 > 1) M3 = 1;
		if(M4 > 1) M4 = 1;
	...
	//Method that gives us reasonable number of cliques (predicted motifs) to consider. It handles equal clique sizes and duplicate predicted motifs
