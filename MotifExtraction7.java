...
public class MotifExtraction7 {
	...
	public static void main(String [] args ) throws FileNotFoundException {
    	...
    	File file2 = new File("Result7.txt");
    	...
    	TM7.add(AminoAcid.A);TM7.add(AminoAcid.Dash);TM7.add(AminoAcid.D);TM7.add(AminoAcid.Dash);TM7.add(AminoAcid.K);TM7.add(AminoAcid.T);TM7.add(AminoAcid.Dash);
