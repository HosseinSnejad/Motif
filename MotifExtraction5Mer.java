...
public class MotifExtraction5Mer {
	...
	public static void main(String [] args ) throws FileNotFoundException {
		...
		File file = new File("Peptides5Mer.txt");
    	...
    	File file2 = new File("Peptides5MerResult.txt");
		PrintStream out = new PrintStream(file2);
		out.println();
		out.println();
		out.println("          "+ "Predefined Motif is: " + "RNA-S-Q");
		out.println("          "+ "Predefined Motif is: " + "K-L-GPS");
		out.println("          "+ "Predefined Motif is: " + "-FM_EIT");
		out.println("          "+ "Predefined Motif is: " + "IQ-VMW-");
		out.println("          "+ "Predefined Motif is: " + "DC-FW-H");
    		...
    		ArrayList<String> Final4Mers = new ArrayList<String>();
    			for(Iterator it = Result.get(k).iterator(); it.hasNext();) {
    				...
    				if(Consensus(Final4Mers).get(0) == AminoAcid.R && Consensus(Final4Mers).get(1) == AminoAcid.N && 
    						...
    						&& Consensus(Final4Mers).get(6) == AminoAcid.Q) {
    					M1+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.K && Consensus(Final4Mers).get(2) == AminoAcid.L && 
    						Consensus(Final4Mers).get(4) == AminoAcid.G && Consensus(Final4Mers).get(5) == AminoAcid.P 
    						&& Consensus(Final4Mers).get(6) == AminoAcid.S) {
    					M2+=1;
    				}
    				else if(Consensus(Final4Mers).get(1) == AminoAcid.F && Consensus(Final4Mers).get(2) == AminoAcid.M && 
    						Consensus(Final4Mers).get(4) == AminoAcid.E && Consensus(Final4Mers).get(5) == AminoAcid.I 
    						&& Consensus(Final4Mers).get(6) == AminoAcid.T) {
    					M3+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.I && Consensus(Final4Mers).get(1) == AminoAcid.Q && 
    						Consensus(Final4Mers).get(3) == AminoAcid.V && Consensus(Final4Mers).get(4) == AminoAcid.M 
    					...
    					M4+=1;
    						...
    						Consensus(Final4Mers).get(3) == AminoAcid.F && Consensus(Final4Mers).get(4) == AminoAcid.W 
