...
public class MotifExtraction6Mer {
	...
	public static void main(String [] args ) throws FileNotFoundException {
		...
		File file = new File("Peptides6Mer.txt");
    	...
    	Result = findCliques(AdjacencyList).stream().filter(c -> c.size() > 1).collect(Collectors.toList());
    	...
    	File file2 = new File("Peptides6MerResult.txt");
		PrintStream out = new PrintStream(file2);
		out.println();
		out.println();
		out.println("          "+ "Predefined Motif is: " + "RNA-SEQ");
		out.println("          "+ "Predefined Motif is: " + "KPMGL-W");
		out.println("          "+ "Predefined Motif is: " + "-FMRIET");
		out.println("          "+ "Predefined Motif is: " + "IQTVMW-");
		out.println("          "+ "Predefined Motif is: " + "DCVFW-H");
		out.println("          "+ "Predefined Motif is: " + "MR-YDKQ");
    ...
    //	ArrayList<AminoAcid> TM7 = new ArrayList<AminoAcid>();
    	...
    	TM1.add(AminoAcid.R);TM1.add(AminoAcid.N);TM1.add(AminoAcid.A);TM1.add(AminoAcid.Dash);TM1.add(AminoAcid.S);TM1.add(AminoAcid.Dash);TM1.add(AminoAcid.Q);
    	TM2.add(AminoAcid.K);TM2.add(AminoAcid.Dash);TM2.add(AminoAcid.L);TM2.add(AminoAcid.Dash);TM2.add(AminoAcid.G);TM2.add(AminoAcid.P);TM2.add(AminoAcid.S);
    	TM3.add(AminoAcid.Dash);TM3.add(AminoAcid.F);TM3.add(AminoAcid.M);TM3.add(AminoAcid.Dash);TM3.add(AminoAcid.E);TM3.add(AminoAcid.I);TM3.add(AminoAcid.T);
    	TM4.add(AminoAcid.I);TM4.add(AminoAcid.Q);TM4.add(AminoAcid.Dash);TM4.add(AminoAcid.V);TM4.add(AminoAcid.M);TM4.add(AminoAcid.W);TM4.add(AminoAcid.Dash);
    	TM5.add(AminoAcid.D);TM5.add(AminoAcid.C);TM5.add(AminoAcid.Dash);TM5.add(AminoAcid.F);TM5.add(AminoAcid.W);TM5.add(AminoAcid.Dash);TM5.add(AminoAcid.H);
    	...
    	for(int j = 0; j < CntNew; j++) {
    		...
    		ArrayList<String> Final4Mers = new ArrayList<String>();
    			for(Iterator it = Result.get(k).iterator(); it.hasNext();) {
    				...
    				if(Consensus(Final4Mers).get(0) == AminoAcid.R && Consensus(Final4Mers).get(1) == AminoAcid.N && 
    						Consensus(Final4Mers).get(2) == AminoAcid.A && Consensus(Final4Mers).get(4) == AminoAcid.S && 
    								Consensus(Final4Mers).get(5) == AminoAcid.E &&	Consensus(Final4Mers).get(6) == AminoAcid.Q) {
    					M1+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.K && Consensus(Final4Mers).get(1) == AminoAcid.P && 
    						Consensus(Final4Mers).get(2) == AminoAcid.M && Consensus(Final4Mers).get(3) == AminoAcid.G &&
    						Consensus(Final4Mers).get(4) == AminoAcid.L && Consensus(Final4Mers).get(6) == AminoAcid.W) {
    					M2+=1;
    				}
    				else if(Consensus(Final4Mers).get(1) == AminoAcid.F && Consensus(Final4Mers).get(2) == AminoAcid.M && 
    						Consensus(Final4Mers).get(3) == AminoAcid.R && Consensus(Final4Mers).get(4) == AminoAcid.I && 
    						Consensus(Final4Mers).get(5) == AminoAcid.E &&Consensus(Final4Mers).get(6) == AminoAcid.T) {
    					M3+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.I && Consensus(Final4Mers).get(1) == AminoAcid.Q && 
    						Consensus(Final4Mers).get(2) == AminoAcid.T && Consensus(Final4Mers).get(3) == AminoAcid.V && 
    						Consensus(Final4Mers).get(4) == AminoAcid.M &&
    						Consensus(Final4Mers).get(5) == AminoAcid.W) {
    					M4+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.D && Consensus(Final4Mers).get(1) == AminoAcid.C && 
    						Consensus(Final4Mers).get(2) == AminoAcid.V &&	Consensus(Final4Mers).get(3) == AminoAcid.F && 
    						Consensus(Final4Mers).get(4) == AminoAcid.W && 
    						Consensus(Final4Mers).get(6) == AminoAcid.H) {
    					M5+=1;
    				}
    				else if(Consensus(Final4Mers).get(0) == AminoAcid.M && Consensus(Final4Mers).get(1) == AminoAcid.R && 
    						Consensus(Final4Mers).get(3) == AminoAcid.Y && Consensus(Final4Mers).get(4) == AminoAcid.D &&
    						Consensus(Final4Mers).get(5) == AminoAcid.K && Consensus(Final4Mers).get(6) == AminoAcid.Q) {
    					M6+=1;
    				}
    				else {
    					falsePositive += 1;
	...
	public static int CountNum(int Cnt, List <Set<Integer>> Result) {
		int CntNew = 1;
